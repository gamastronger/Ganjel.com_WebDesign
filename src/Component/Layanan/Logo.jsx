const Logo = () => {
    return (
      <div className="relative bg-[#0F172A] flex flex-col 2xl:flex-row items-center justify-center text-white px-4 -mt-1 md:pt-8 2xl:-mt-28 2xl:px-24 mb-20 2xl:pb-10 overflow-hidden">
        {/* Right Section (Cards) */}
        <div className="2xl:flex 2xl:flex-row 2xl:space-x-8 w-full flex justify-center pt-20 pb-14 md:pb-12 md:pt-20 2xl:px-0 relative z-10">
