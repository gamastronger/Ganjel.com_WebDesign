const Logo = () => {
    return (
      <div className="relative bg-[#0F172A] flex flex-col xl:flex-row items-center justify-center text-white px-4 -mt-1 md:pt-8 xl:-mt-28 xl:px-24 mb-20 xl:pb-10 overflow-hidden">
        {/* Right Section (Cards) */}
        <div className="xl:flex xl:flex-row xl:space-x-8 w-full flex justify-center pt-20 pb-14 md:pb-12 md:pt-20 xl:px-0 relative z-10">
          ...
          <div className="relative xl:mt-24 xl:static w-48 h-32 md:w-[350px] md:h-[250px] xl:w-[320px] xl:h-[200px] bg-slate-300 rounded-lg shadow-lg opacity-90 transform rotate-[5deg] hover:rotate-0 hover:scale-110 transition-all duration-500 ease-in-out hover:shadow-xl">
            <div className="absolute inset-0 -z-10 bg-blue-400 opacity-60 blur-xl rounded-lg"></div> {/* Blue Blur */}
            <div className="h-full flex items-center justify-center text-lg md:text-xl font-semibold text-black">
              Actions
            </div>
