...
const Judul = () => {
  return (
    ...
    >
      <div className="mx-auto text-center px-6 xl:px-8 md:mt-6 xl:mt-16 md:mx-5">
        <p className="text-4xl md:text-5xl xl:text-[65px] font-semibold tracking-tight">
          Layanan Grafistix
        </p>
        <p className="pt-4 xl:pt-8 text-[15px] md:text-lg">
          Kami adalah pilihan tepat untuk Anda yang membutuhkan desain grafis
          profesional, kreatif, dan berkualitas.
        </p>
        <div className="pt-8 md:pt-12 xl:pt-16 flex justify-center">
          <img className="" src={pict} alt="Layanan Grafistix" />
        </div>
      </div>
      <div className="mx-auto px-6 xl:px-8 mt-8 md:pt-10 xl:pt-12 text-[15px] text-white md:text-lg md:text-center md:mx-5">
