const Custom = () => {
    return (
      <div className="relative bg-[#0F172A] flex flex-col xl:flex-row items-center justify-center text-white px-4 -mt-16 md:pt-16 xl:-mt-56 xl:px-24 mb-20 xl:pb-20 overflow-hidden">
        {/* Right Section (Cards) */}
        <div className="xl:flex xl:flex-row xl:space-x-8 w-full flex justify-center pt-20 pb-14 md:pb-12 md:pt-20 xl:px-0 relative z-10 xl:order-last">
