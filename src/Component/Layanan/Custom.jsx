const Custom = () => {
    return (
      <div className="relative bg-[#0F172A] flex flex-col 2xl:flex-row items-center justify-center text-white px-4 -mt-16 md:pt-16 2xl:-mt-56 2xl:px-24 mb-20 2xl:pb-20 overflow-hidden">
        {/* Right Section (Cards) */}
